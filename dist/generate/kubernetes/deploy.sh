...
echo ""
echo "Create cacheman-downloader service"
kubectl apply -f service.yaml

echo ""
echo "Create cacheman-downloader prometheus metrics"
kubectl apply -f prometheus.yaml

echo ""
echo "Rollout cacheman-downloader deployment"
kubectl rollout restart deployment cacheman-downloader
